...
export function registerSpreadsheetTools(server) {
    ...
    // =========================================================================
    server.registerTool('list_spreadsheets', {
    ...
    // =========================================================================
    server.registerTool('get_spreadsheet', {
    ...
    // =========================================================================
    server.registerTool('update_spreadsheet', {
    ...
    // =========================================================================
    server.registerTool('delete_spreadsheet', {
    ...
    // =========================================================================
    server.registerTool('update_cell', {
    ...
    // =========================================================================
    server.registerTool('update_cells_batch', {
    ...
    // =========================================================================
    server.registerTool('rename_sheet', {
    ...
    // =========================================================================
    server.registerTool('clear_range', {
