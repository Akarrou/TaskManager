...
export function registerProjectTools(server) {
    ...
    // =========================================================================
    server.tool('update_project', `Update a project's name or description. Use this to rename projects or update their description. Only provide the fields you want to change - unchanged fields keep their current values. Returns the updated project object. Note: This does not change project membership or archive status - use specific tools for those operations.`, {
    ...
    // =========================================================================
    server.tool('archive_project', `Archive a project to hide it from the default project list. Archived projects are not deleted - they retain all their data and can be restored with restore_project. Use archiving for completed projects or ones no longer actively used. Archived projects are still accessible via list_projects with include_archived=true. This is a soft-delete operation - use delete_project for permanent removal.`, {
    ...
    // =========================================================================
    server.tool('delete_project', `Move a project to the trash (soft delete). The project is marked as deleted but can be restored within 30 days using restore_from_trash. Child documents remain intact but are inaccessible while the project is in the trash. On restore, everything reappears. For temporary hiding without deletion, use archive_project instead. A snapshot is taken before deletion for additional recovery.`, {
