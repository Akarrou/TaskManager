...
export function registerTabTools(server) {
    ...
    // =========================================================================
    server.tool('list_tabs', 'List all tabs for a project.', {
    ...
    // =========================================================================
    server.tool('create_tab', 'Create a new tab in a project.', {
        project_id: z.string().uuid().describe('The UUID of the project'),
    ...
    // =========================================================================
    server.tool('update_tab', 'Update a tab\'s properties.', {
    ...
    // =========================================================================
    server.tool('delete_tab', 'Delete a tab from a project.', {
    ...
    // =========================================================================
    server.tool('set_default_tab', 'Set a tab as the default tab for a project.', {
    ...
    // =========================================================================
    server.tool('reorder_tabs', 'Reorder tabs by providing an ordered array of tab IDs.', {
    ...
    // =========================================================================
    server.tool('list_tab_groups', 'List all tab groups for a project.', {
        project_id: z.string().uuid().describe('The UUID of the project'),
    }, async ({ project_id }) => {
        try {
            const supabase = getSupabaseClient();
    ...
    // =========================================================================
    server.tool('create_tab_group', 'Create a new tab group in a project.', {
        project_id: z.string().uuid().describe('The UUID of the project'),
    ...
    // =========================================================================
    server.tool('update_tab_group', 'Update a tab group\'s properties.', {
    ...
    // =========================================================================
    server.tool('delete_tab_group', 'Delete a tab group. Tabs in the group will be ungrouped, not deleted.', {
    ...
    // =========================================================================
    server.tool('list_sections', 'List all sections for a tab.', {
        tab_id: z.string().uuid().describe('The UUID of the tab'),
    }, async ({ tab_id }) => {
        try {
            const supabase = getSupabaseClient();
    ...
    // =========================================================================
    server.tool('create_section', 'Create a new section in a tab.', {
        tab_id: z.string().uuid().describe('The UUID of the tab'),
    ...
    // =========================================================================
    server.tool('update_section', 'Update a section\'s properties.', {
    ...
    // =========================================================================
    server.tool('delete_section', 'Delete a section from a tab.', {
