...
export function registerProjectTools(server: McpServer): void {
  ...
  server.tool(
    'list_projects',
    'List all projects. Can filter to include/exclude archived projects.',
    {
  ...
  server.tool(
    'archive_project',
    'Archive a project. Archived projects can be restored later.',
    {
  ...
  server.tool(
    'delete_project',
    'Permanently delete a project and all its related data (documents, tasks, databases, etc.). This action cannot be undone.',
    {
