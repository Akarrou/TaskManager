...
export function registerDatabaseTools(server: McpServer): void {
  ...
  server.tool(
    'list_databases',
    'List all dynamic databases (Notion-like tables) in the system.',
    {
  ...
  server.tool(
    'get_database_schema',
    'Get the schema (columns configuration) of a database.',
    {
  ...
  server.tool(
    'get_database_rows',
    'Get rows from a database with optional filtering and sorting.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
  ...
  server.tool(
    'add_database_row',
    'Add a new row to a database. Provide cell values as a JSON object mapping column names to values.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
  ...
  server.tool(
    'update_database_row',
    'Update specific cells in a database row.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
    ...
    async ({ database_id, row_id, cells }) => {
      try {
        ...
        const existingCells = currentRow.cells as Record<string, unknown>;
  ...
  server.tool(
    ...
    'Delete one or more rows from a database.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
  ...
  server.tool(
    'create_database',
    'Create a new Notion-like database with columns configuration.',
    {
  ...
  server.tool(
    'delete_database',
    'Delete a database and all its data. This action cannot be undone.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
  ...
  server.tool(
    'update_column',
    'Update a column\'s properties in a database.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
  ...
  server.tool(
    'delete_column',
    'Delete a column from a database. Existing cell data for this column will be lost.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
  ...
  server.tool(
    'import_csv',
    'Import CSV data into a database. The CSV must have a header row matching column names.',
    {
      database_id: z.string().describe('The database ID (format: db-uuid)'),
