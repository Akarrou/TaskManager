-- =====================================================================
-- FIX: Créer uniquement les fonctions RPC manquantes
-- =====================================================================
-- Ce script crée les fonctions RPC sans toucher à la table existante
-- =====================================================================

-- 1. Fonction: create_dynamic_table
...
-- 2. Fonction: add_column_to_table
...
-- 3. Fonction: delete_column_from_table
...
-- 4. Fonction: delete_dynamic_table
...
-- 5. Fonction: update_updated_at_column (trigger function)
...
-- 6. Fonction: create_update_trigger
...
SELECT COUNT(*) as nb_fonctions_rpc FROM information_schema.routines
